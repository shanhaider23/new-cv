<template>
	<div class="work">
		...
		<Company name="Dianox" post="Fullstack Developer" :from="new Date(2021, 2)" :to="new Date(2022, 5)">
			<li>Built and managed the full-stack web app from scratch by using technologies Next.js, TypeScript, AWS and MongoDB.</li>
		...
		<Company name="Cellari" post="Frontend Developer" :from="new Date(2021, 12)" :to="new Date(2022, 5)">
			<li>Worked with JavaScript (Vanilla.js), Docker, CSS, and HTML.</li>
			<li>Managed time-sensitive updates, including content changes and database upgrades.</li>
			<li>Improved existing platform and user interface features while developing new features and initiatives.</li>
			<div class="expirience-job__list">
				<div class="expirience-job__item">Vanilla.js</div>
				<div class="expirience-job__item">CSS</div>
				<div class="expirience-job__item">Docker</div>
